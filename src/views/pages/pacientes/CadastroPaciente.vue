    ...
    <div class="card">
        <div class="flex align-items-center justify-content-between mb-4 flex-wrap">
            ...
            <div class="flex gap-2">
                <Button label="Voltar" icon="pi pi-arrow-left" severity="secondary" @click="$router.push('/pacientes')"
                    class="p-button-outlined" />
                <Button label="Salvar Paciente" icon="pi pi-check" @click="salvarPaciente" :loading="isLoading" />
            </div>
        </div>
                    ...
                    <div class="p-fluid">
                        <div class="grid">
                            ...
                            <div class="col-12 md:col-4">
                                ...
                                <InputMask id="data_nascimento" v-model="paciente.data_nascimento"
                                    placeholder="00/00/0000" class="w-full" mask="99/99/9999" />
                            </div>
                            <div class="col-12 md:col-4">
                                <label for="nome_mae" class="text-600 mb-2 block">Nome da Mãe</label>
                                <InputText id="nome_mae" v-model="paciente.nome_mae" placeholder="Digite o nome da mãe"
                                    class="w-full" />
                            </div>
                            <div class="col-12 md:col-4">
                                <label for="nome_pai" class="text-600 mb-2 block">Nome do Pai</label>
                                <InputText id="nome_pai" v-model="paciente.nome_pai" placeholder="Digite o nome do pai"
                                    class="w-full" />
                            </div>
                            <div class="col-12 md:col-4">
                            ...
                            <div class="col-12 md:col-6">
                                ...
                                <InputText id="rg" v-model="paciente.rg" placeholder="Digite o RG" class="w-full" />
                            </div>
                            <div class="col-12 md:col-6">
                                <label for="naturalidade" class="text-600 mb-2 block">Naturalidade</label>
                                <InputText id="naturalidade" v-model="paciente.naturalidade" placeholder="Cidade/Estado"
                                    class="w-full" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-fluid">
                        <div class="grid">
                            <div class="col-12 md:col-6">
                                ...
                                <Dropdown id="escolaridade" v-model="paciente.escolaridade" :options="escolaridades"
                                    placeholder="Selecione a escolaridade" class="w-full" />
                            </div>
                            <div class="col-12 md:col-6">
                                <label for="data_inicio_tratamento" class="text-600 mb-2 block">Início do
                                    Tratamento</label>
                                <InputMask id="data_inicio_tratamento" v-model="paciente.data_inicio_tratamento"
                                    placeholder="00/00/0000" class="w-full" mask="99/99/9999" />
                            </div>
                            <div class="col-12 md:col-6">
                                <label for="profissao" class="text-600 mb-2 block">Profissão</label>
                                <Dropdown id="profissao" v-model="paciente.profissao" :options="profissoes"
                                    placeholder="Selecione a profissão" class="w-full" />
                            </div>
                            <div class="col-12 md:col-6" v-if="paciente.profissao === 'Outro'">
                                ...
                                <InputText id="outra_profissao" v-model="paciente.outra_profissao"
                                    placeholder="Digite a profissão" class="w-full" />
                            </div>
                            <div class="col-12 md:col-6">
                                <label for="convenio" class="text-600 mb-2 block">Convênio</label>
                                <Dropdown id="convenio" v-model="paciente.convenio" :options="convenios"
                                    placeholder="Selecione o convênio" class="w-full" />
                            </div>
                            <div class="col-12 md:col-6" v-if="paciente.convenio === 'Outro'">
                                ...
                                <InputText id="outro_convenio" v-model="paciente.outro_convenio"
                                    placeholder="Digite o convênio" class="w-full" />
                            </div>
                        </div>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="grid">
                                <div class="col-12 md:col-6">
                                    ...
                                    <div class="flex gap-3">
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.toma_medicacao" inputId="nao_toma_medicacao"
                                                name="toma_medicacao" :value="0" />
                                            <label for="nao_toma_medicacao" class="ml-2 text-600">Não</label>
                                        </div>
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.toma_medicacao" inputId="toma_medicacao"
                                                name="toma_medicacao" :value="1" />
                                ...
                                <div class="col-12" v-if="paciente.toma_medicacao === 1">
                                    <label for="especificacao_medicacao" class="text-600 mb-2 block">Especificação da
                                        Medicação</label>
                                    <Textarea id="especificacao_medicacao" v-model="paciente.especificacao_medicacao"
                                        rows="3" placeholder="Descreva as medicações utilizadas" class="w-full" />
                                </div>
                                ...
                                <div class="col-12 md:col-6">
                                    ...
                                    <div class="flex gap-3">
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.tem_contato_emergencia"
                                                inputId="nao_tem_contato_emergencia" name="tem_contato_emergencia"
                                                :value="0" />
                                            <label for="nao_tem_contato_emergencia" class="text-600 ml-2">Não</label>
                                        </div>
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.tem_contato_emergencia"
                                                inputId="tem_contato_emergencia" name="tem_contato_emergencia"
                                                :value="1" />
                                ...
                                <div class="col-12 md:col-6" v-if="paciente.tem_contato_emergencia === 1">
                                    <label for="contato_emergencia" class="text-600 mb-2 block">Contato de
                                        Emergência</label>
                                    <InputMask id="contato_emergencia" v-model="paciente.contato_emergencia"
                                        placeholder="(00) 00000-0000" class="w-full" mask="(99) 99999-9999" />
                                </div>
                                ...
                                <div class="col-12 md:col-6">
                                    ...
                                    <div class="flex gap-3">
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.faz_outro_acompanhamento_medico"
                                                inputId="nao_faz_outro_acompanhamento_medico"
                                                name="faz_outro_acompanhamento_medico" :value="0" />
                                            <label for="nao_faz_outro_acompanhamento_medico"
                                                class="ml-2 text-600">Não</label>
                                        </div>
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.faz_outro_acompanhamento_medico"
                                                inputId="faz_outro_acompanhamento_medico"
                                                name="faz_outro_acompanhamento_medico" :value="1" />
                                            <label for="faz_outro_acompanhamento_medico"
                                                class="ml-2 text-600">Sim</label>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-12" v-if="paciente.faz_outro_acompanhamento_medico === 1">
                                    <label for="descricao_outro_acompanhamento" class="text-600 mb-2 block">Descrição do
                                        Outro
                                        Tratamento</label>
                                    <Textarea id="descricao_outro_acompanhamento"
                                        v-model="paciente.descricao_outro_acompanhamento" rows="3"
                                        placeholder="Descreva o outro tratamento" class="w-full" />
                                </div>
                                ...
                                <div class="col-12 md:col-6">
                                    ...
                                    <div class="flex gap-3">
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.is_menor_idade" inputId="nao_is_menor_idade"
                                                name="is_menor_idade" :value="0" />
                                            <label for="nao_is_menor_idade" class="ml-2 text-600">Não</label>
                                        </div>
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.is_menor_idade" inputId="is_menor_idade"
                                                name="is_menor_idade" :value="1" />
                                ...
                                <div class="col-12 md:col-6" v-if="paciente.is_menor_idade === 1">
                                    <label for="contato_responsavel" class="text-600 mb-2 block">Contato do
                                        Responsável</label>
                                    <InputMask id="contato_responsavel" v-model="paciente.contato_responsavel"
                                        placeholder="(00) 00000-0000" class="w-full" mask="(99) 99999-9999" />
                                </div>
                                ...
                                <div class="col-12 md:col-6">
                                    ...
                                    <div class="flex gap-3">
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.tem_diagnostico_previo"
                                                inputId="nao_tem_diagnostico_previo" name="tem_diagnostico_previo"
                                                :value="0" />
                                            <label for="nao_tem_diagnostico_previo" class="ml-2 text-600">Não</label>
                                        </div>
                                        <div class="flex align-items-center">
                                            <RadioButton v-model="paciente.tem_diagnostico_previo"
                                                inputId="tem_diagnostico_previo" name="tem_diagnostico_previo"
                                                :value="1" />
                                ...
                                <div class="col-12" v-if="paciente.tem_diagnostico_previo === 1">
                                    <label for="descricao_diagnostico_previo" class="text-600 mb-2 block">Descrição do
                                        Diagnóstico</label>
                                    <Textarea id="descricao_diagnostico_previo"
                                        v-model="paciente.descricao_diagnostico_previo" rows="3"
                                        placeholder="Descreva o diagnóstico prévio" class="w-full" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-fluid">
                        <div class="grid">
                            <div class="col-12 md:col-4">
                                ...
                                <InputMask id="cep" v-model="paciente.cep" placeholder="00000-000" class="w-full"
                                    mask="99999-999" @blur="buscarCep" />
                            </div>
                            <div class="col-12 md:col-8">
                                <label for="rua" class="text-600 mb-2 block">Rua</label>
                                <InputText id="rua" v-model="paciente.rua" placeholder="Digite o nome da rua"
                                    class="w-full" />
                            </div>
                            <div class="col-12 md:col-6">
                                <label for="bairro" class="text-600 mb-2 block">Bairro</label>
                                <InputText id="bairro" v-model="paciente.bairro" placeholder="Digite o bairro"
                                    class="w-full" />
                            </div>
                            <div class="col-12 md:col-3">
                                <label for="cidade" class="text-600 mb-2 block">Cidade</label>
                                <InputText id="cidade" v-model="paciente.cidade" placeholder="Digite a cidade"
                                    class="w-full" />
                            </div>
                            <div class="col-12 md:col-3">
                                <label for="estado" class="text-600 mb-2 block">Estado</label>
                                <InputText id="estado" v-model="paciente.estado" placeholder="UF" class="w-full" />
                            </div>
                        </div>
                    </div>
                </AccordionTab>
            ...
            <Card class="bg-gray-900">
                <template #content>
                    <div class=" d-flex gap-3 justify-content-between">
                        ...
                        <Button icon="pi pi-check" class="outline" :loading="isLoading" @click="salvarPaciente"
...
export default {
    ...
    mounted() {
        // Marcar que o formulário foi inicializado após o mount
        this.$nextTick(() => {
    ...
    methods: {
        ...
        cancelarAlteracoes() {
            ...
            setTimeout(() => {
                // Resetar formulário para estado inicial (sem disparar watcher)
                this.paciente = {
                    nome: '',
                    nome_mae: '',
                    nome_pai: '',
