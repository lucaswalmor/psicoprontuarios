<template>
    <div class="p-4">
        ...
        <!-- Temas Tratados -->
        <div class="flex align-items-center justify-content-between mb-4" data-tour="tour-meusite-esp-temas-intro">
            <div>
            ...
            <Button
                data-tour="tour-meusite-esp-salvar-temas"
                label="Salvar especialidades"
                icon="pi pi-check"
                :loading="salvandoTemas"
                @click="salvarTemas"
            />
        </div>

        <div data-tour="tour-meusite-esp-temas-chips">
        ...
        <div class="flex align-items-center justify-content-between mb-4" data-tour="tour-meusite-esp-abordagens-intro">
            <div>
            ...
            <Button
                data-tour="tour-meusite-esp-salvar-abordagens"
                label="Salvar abordagens"
                icon="pi pi-check"
                :loading="salvandoEsp"
                @click="salvarEspecialidades"
            />
        </div>

        <div data-tour="tour-meusite-esp-abordagens-chips">
