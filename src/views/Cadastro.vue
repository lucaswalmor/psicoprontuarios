...
export default {
  ...
  methods: {
    ...
    gerarPix() {
      ...
      this.axios.get(`https://projetopix.lksoftware.com.br/public/api/novo-pix?valor=${valor}&system=psicoprontuarios&cpfCnpj=${this.usuario.cpf}&email=${this.usuario.email}&telefone=${this.usuario.telefone}&nome=${this.usuario.nome + ' ' + this.usuario.sobrenome}`).then(res => {
