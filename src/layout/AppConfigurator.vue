...
<template>
    <div
        ...
        <div class="flex flex-col gap-4">
            <div>
                ...
                <div class="pt-2 flex gap-2 flex-wrap">
                    <button v-for="primaryColor of primaryColors" :key="primaryColor.name" type="button"
                        ...
                        :class="['border-none w-2 h-5 rounded-full p-0 cursor-pointer outline-none outline-offset-1', { 'outline-primary': layoutConfig.primary === primaryColor.name }]"
                ...
                <div class="pt-2 flex gap-2 flex-wrap">
                    <button v-for="surface of surfaces" :key="surface.name" type="button" :title="surface.name"
                        @click="updateColors('surface', surface)" :class="[
                            'border-none w-2 h-5 rounded-full p-0 cursor-pointer outline-none outline-offset-1',
            ...
            <div class="flex flex-col gap-2">
                <span class="text-sm text-muted-color font-semibold">Menu Lateral</span>
