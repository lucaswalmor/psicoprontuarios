    ...
    methods: {
        updateBreadcrumb() {
            ...
            const routeNameMapping = {
                ...
                'Ficha do Paciente': 'Ficha do Paciente',
                'FichaPacienteDados': 'Dados Pessoais',
                'FichaPacienteProntuarios': 'Prontuários',
                'FichaPacienteSessoes': 'Sessões',
                'FichaPacienteAnexos': 'Anexos',
                'FichaPacienteAnamnese': 'Anamnese',
                'FichaPacienteEvolucao': 'Evolução',
                'Prontuarios': 'Prontuários',
                'Anexos': 'Anexos',
                'ficha': 'Ficha',
