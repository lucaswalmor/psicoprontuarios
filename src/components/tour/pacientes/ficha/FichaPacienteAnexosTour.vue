...
const STEPS = [
    {
        attachTo: { element: '[data-tour="tour-ficha-anexos-upload"]' },
        content: {
            title: 'Upload de anexo',
            description:
                'Abre o diálogo para enviar um novo arquivo (PDF, imagem, documento etc.) vinculado a este paciente. Se o status do tratamento estiver "Concluído", o sistema pode bloquear novos uploads até você reativar o caso.'
        },
        options: popperBottomStart
    },
    {
        attachTo: { element: '[data-tour="tour-ficha-anexos-tabela"]' },
        content: {
            title: 'Lista de anexos',
            description:
                'Arquivos já enviados com nome, tamanho, tipo e data. Use o ícone de download para baixar uma cópia e a lixeira para excluir (com confirmação).'
        },
