...
const STORAGE_KEY = 'psico_prontuario_tour_ficha_paciente_tab_anamnese_v1';
...
const STEPS = [
    {
        attachTo: { element: '[data-tour="tour-ficha-anamnese-salvar"]' },
        content: {
            title: 'Salvar anamnese',
            description:
                'Grava no servidor todas as alterações feitas nos campos abaixo. Se o paciente estiver com status "Concluído", será necessário alterar o status no cabeçalho da ficha antes de salvar.'
        },
        options: popperBottomStart
    },
    {
        attachTo: { element: '[data-tour="tour-ficha-anamnese-form"]' },
        content: {
            title: 'Formulário da anamnese',
            description:
                'História clínica estruturada: motivo da consulta, quadro atual, sintomas, histórico médico/psiquiátrico, medicamentos, vínculos e demais campos do protocolo. Role a página para preencher todas as seções.'
        },
...
export default {
    name: 'FichaPacienteAnamneseTour',
    components: { VOnboardingWrapper, VOnboardingStep },
    data() {
        return {
            dismissed: false,
            steps: STEPS,
            firstTargetSelector: '[data-tour="tour-ficha-anamnese-salvar"]',
            wrapperOptions: {
