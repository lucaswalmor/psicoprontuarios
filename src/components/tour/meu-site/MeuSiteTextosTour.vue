...
const STEPS = [
    {
        attachTo: { element: '[data-tour="tour-meusite-textos-nav-nome"]' },
        content: {
            title: 'Nome na navegação',
            description: 'Texto exibido ao lado do logo ou na barra superior do site público (ex.: como você quer ser chamado).'
        },
        options: popperBottomStart
    },
    {
        attachTo: { element: '[data-tour="tour-meusite-textos-hero-eyebrow"]' },
        content: {
            title: 'Eyebrow do hero',
            description: 'Linha pequena acima do título principal — costuma ser CRP ou uma frase curta de credibilidade.'
        },
        options: popperBottomStart
    },
    {
        attachTo: { element: '[data-tour="tour-meusite-textos-hero-titulo"]' },
        content: {
            title: 'Título principal (hero)',
            description: 'Manchete principal da primeira dobra da landing; deve comunicar em uma linha o benefício ou proposta.'
        },
        options: popperBottomStart
    },
    {
        attachTo: { element: '[data-tour="tour-meusite-textos-hero-subtitulo"]' },
        content: {
            title: 'Subtítulo do hero',
            description: 'Complemento logo abaixo do título, com tom acolhedor ou explicativo.'
        },
        options: popperBottomStart
    },
    {
        attachTo: { element: '[data-tour="tour-meusite-textos-hero-descricao"]' },
        content: {
            title: 'Descrição do hero',
            description: 'Parágrafo mais longo na abertura: segurança, formato de sessão ou público que você atende.'
        },
    ...
    },
    {
        ...
        content: {
            ...
            description: 'Cabeçalho da área “Sobre mim” na landing.'
        },
        options: popperBottomStart
    },
    {
    ...
    },
    {
        ...
        content: {
            ...
            description: 'Primeiro bloco da sua história profissional ou abordagem clínica.'
        },
        options: popperBottom
    },
    {
        attachTo: { element: '[data-tour="tour-meusite-textos-sobre-bio2"]' },
        content: {
            title: 'Biografia — parágrafo 2',
            description: 'Segundo parágrafo: público, modalidades ou convite para contato.'
        },
        options: popperBottom
    },
    {
        attachTo: { element: '[data-tour="tour-meusite-textos-salvar"]' },
        content: {
            title: 'Salvar textos',
            description: 'Persiste todos os campos de textos do hero e da seção Sobre no servidor.'
        },
        options: popperBottomStart
    }
];
