            ...
            <div class="grid">
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.motivo_consulta" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.historia_problema_atual" rows="4"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.sintomas_principais" rows="3"
                ...
                <div class="col-12 md:col-6">
                    <div class="field">
                        ...
                        <Textarea v-model="form.duracao_sintomas" rows="2"
                ...
                <div class="col-12 md:col-6">
                    <div class="field">
                        ...
                        <Textarea v-model="form.intensidade_sintomas" rows="2"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.fatores_desencadeantes" rows="3"
                ...
                <div class="col-12 md:col-6">
                    <div class="field">
                        ...
                        <Textarea v-model="form.fatores_melhoram" rows="2"
                ...
                <div class="col-12 md:col-6">
                    <div class="field">
                        ...
                        <Textarea v-model="form.fatores_pioram" rows="2" placeholder="O que piora os sintomas?"
                            class="w-full" />
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.impacto_vida_diaria" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.tentativas_tratamento_anteriores" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.medicamentos_atuais" rows="2"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.historico_psiquiatrico" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.historico_medico" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.historico_familiar" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.substancia_uso" rows="2" placeholder="Uso de álcool, tabaco, drogas..."
                            class="w-full" />
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.relacionamentos" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.trabalho_estudo" rows="2"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.atividades_lazer" rows="2"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.suporte_social" rows="2"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.expectativas_tratamento" rows="3"
                ...
                <div class="col-12">
                    <div class="field">
                        ...
                        <Textarea v-model="form.observacoes_adicionais" rows="3"
