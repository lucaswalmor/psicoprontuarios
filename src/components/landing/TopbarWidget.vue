    ...
    <nav class="navbar">
        ...
        <div class="navbar-brand">
            <a class="flex items-center" href="#">
                ...
                <span class="brand-text">PsicoProntuários</span>
            </a>
        </div>
...
.brand-text {
    @apply text-surface-900 dark:text-surface-0 font-bold text-xl ml-3;
}
...
.nav-link {
    @apply px-0 py-2 text-surface-900 dark:text-surface-0 font-medium text-lg cursor-pointer transition-colors duration-200 hover:text-primary;
}
...
.signup-btn {
    @apply bg-gradient-to-r from-blue-600 to-purple-600 border-0 hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl;
}
