...
export default {
    ...
    data() {
        return {
            ...
            /** Incrementado após I.A para forçar o Quill a exibir o novo HTML (modelValue externo). */
    ...
    methods: {
        ...
        /**
         * n8n costuma devolver um objeto ou um array com um item: [{ "mensagem": "..." }].
         */
        ...
        /**
         * n8n pode devolver texto direto ou uma string com ```json\n{ "mensagem": "..." }\n```.
         */
